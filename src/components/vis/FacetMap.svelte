...
<script>
    ...
    //     "0": {
    //         "name": "Durable housing (buildings)",
    //         "today": [
    //             {
    //                 "type": "count",
    //                 "id": 0,
    ...
    //     },
    //     "3": {
    //         "name": "Access cultural heritage institutions",
    //         "today": [
    //             {
    //                 "type": "count",
    //                 "id": 0,
    ...
    //     },
    //     "4": {
    //         "name": "Access to natural areas wooded and grassland areas, and water bodies",
    //         "today": [
    //             {
    //                 "type": "count",
    //                 "id": 0,
    ...
    //     },
    //     "13": {
    //         "name": "Availability of (public) drinking water services",
    //         "today": [
    //             {
    //                 "type": "count",
    //                 "id": 0,
        ...
        <g id = "goals-wrapper"> <!-- Scroll wrapper to have one SDG in view -->
            ...
            <g class ='goal-group goal-{slugify(goalNo)}' style = 'transform:translate({dims.width - layout.goalWidth - 2 *dims.margin.right}px, {i * dims.height }px)'>
                ...
                <image class = 'target-tile'  x = {dims.margin.right}  y= {dims.margin.right} width= {layout.goalWidth}  
                    xlink:href = './static/img/the-global-goals-goals-and-targets/goal-{$ui.state.bySection.explore.sdg}/GOAL_{$ui.state.bySection.explore.sdg}_TARGETS/GOAL_{$ui.state.bySection.explore.sdg}_TARGETS_SVG/GOAL_{$ui.state.bySection.explore.sdg}_TARGET_{showTarget}.svg'/>
                {/if}
                ...
                <g class = 'target-group target-{slugify(targetNo)}'  target={targetNo} on:mouseover|stopPropagation={handleTargetMouseover}   on:mouseout={handleMouseout}  >
                    <g class ="target-wrapper" style = 'transform:translate({-layout.targetWidth}px, {(j) * (layout.targetHeight + layout.targetGap) +dims.margin.top}px)'>
                        ...
                        <image class = 'target-tile'  x = {0} height= {layout.targetHeight}  
                            xlink:href = './static/img/the-global-goals-goals-and-targets/goal-{goalNo}/GOAL_{goalNo}_TARGETS/GOAL_{goalNo}_TARGETS_SVG/GOAL_{goalNo}_TARGET_{targetNo}.svg'/>
